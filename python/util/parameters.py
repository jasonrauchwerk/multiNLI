...
def load_parameters():
    FIXED_PARAMETERS = {
        ...
        "training_mnli": "{}/multinli_1.0_train.jsonl".format(args.datapath),
        "dev_matched": "{}/multinli_1.0_dev_matched.jsonl".format(args.datapath),
        "dev_mismatched": "{}/multinli_1.0_dev_mismatched.jsonl".format(args.datapath),
        "test_matched": "{}/multinli_1.0_dev_matched_replaced.jsonl".format(args.datapath),
        "test_mismatched": "{}/multinli_1.0_dev_mismatched_replaced.jsonl".format(args.datapath),
